...
var SubsectionComponent = /** @class */ (function () {
    ...
    SubsectionComponent.prototype.usePromotionalCode = function () {
        ...
        this.subsectionService.usePromotionalCode({ price: this.buyModal.price, slug: this.buyModal.slug, promo: this.promo }).then(function (data) {
            _this.buyModal.price = data;
        }, function (error) {
...
var WorkComponent = /** @class */ (function () {
    function WorkComponent(workService, router, globalParamsMessage, activatedRoute, globalParamsUser, sanitizer) {
        ...
        this.lesson = { id: '', name: '', section_id: '', slug: '' };
        ...
        this.activatedRoute.params.subscribe(function (params) {
            _this.getWorkCurrent('2', params.id);
        });
    }
    WorkComponent.prototype.getWorkCurrent = function (is_status, slug, slugLesson) {
        var _this = this;
