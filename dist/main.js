...
var AuthComponent = /** @class */ (function () {
    function AuthComponent(authService, globalParamsMessage, router, reviewsService, menuService) {
        ...
        this.reviewsService.getReviews().then(function (datas) {
            _this.reviews = datas;
        }, function (error) {
...
module.exports = "<div class=\"---block-title ---d-flex ---flex-column ---md-flex-row ---align-items-start ---md-align-items-center ---justify-content-between\">\n  Отзывы учеников\n\n  <span class=\"---cursor-pointer ---button ---button--acent_orange\" (click)=\"newReviews.show=true\">\n    Добавить отзыв\n  </span>\n</div>\n\n<div class=\"---block-reviews ---block-reviews--in\">\n  <div class=\"---row\">\n    <div class=\"col-xl-6\" *ngFor=\"let review of reviews\">\n      <div class=\"---item\">\n        <div class=\"---item-header ---pos-rel\">\n          <a href=\"{{review.url_vk}}\" target=\"_blank\">\n          <img lazyLoad=\"{{review.img}}\" alt=\"\" class=\"---img\">\n          </a>\n          <a href=\"{{review.url_vk}}\" target=\"_blank\">\n            <div class=\"---name\">{{review.last_name}} {{review.first_name}}</div>\n          </a>\n          <div class=\"---thumb\">Курс: {{review.subject_name}} / Оценка <b class=\"---font-800\">{{review.rating}}</b></div>\n        </div>\n        <p>{{review.description}}</p>\n      </div>\n    </div>\n  </div>\n\n</div>\n<div class=\"---devider ---devider--sm\"></div>\n\n\n<div *ngIf=\"newReviews.show===true\" class=\"---modal ---d-flex ---justify-content-center ---align-items-start\">\n  <div class=\"---wrapper ---wrapper_review ---text-center\">\n\n    <div class=\"---input-wrap\">\n      <div class=\"---input-label\">Выберите предмет</div>\n      <select [(ngModel)]=\"newReviews.predmet\" class=\"---select\" style=\"background-color: #f1f5f7;\">\n        <option *ngFor=\"let currentMenu of menu\" [ngValue]=\"currentMenu\">{{currentMenu.title}}</option>\n      </select>\n    </div>\n\n    <div class=\"---input-wrap\">\n      <div class=\"---input-label\">Выберите оценку</div>\n      <select [(ngModel)]=\"newReviews.rating\" class=\"---select\" style=\"background-color: #f1f5f7;\">\n        <option ngValue=\"1\">1</option>\n        <option ngValue=\"2\">2</option>\n        <option ngValue=\"3\">3</option>\n        <option ngValue=\"4\">4</option>\n        <option ngValue=\"5\">5</option>\n      </select>\n    </div>\n\n    <div class=\"---input-wrap\">\n      <div class=\"---input-label\">Описание</div>\n      <textarea [(ngModel)]=\"newReviews.description\" class=\"---input\" style=\"background-color: #f1f5f7;\" rows=\"6\"></textarea>\n    </div>\n\n    <div class=\"---cursor-pointer ---button ---button--acent_orange\" (click)=\"createReviews()\">\n      Отправить\n    </div>\n\n\n    <div (click)=\"newReviews.show=false\"\n         class=\"---cursor-pointer ---icon-close ---icon-font ---icon-close ---x-pos-abs\"></div>\n  </div>\n</div>\n"
...
var SubsectionService = /** @class */ (function () {
    ...
    SubsectionService.prototype.getSubSection = function (slug) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.httpService.prepareQuery('api/sections/details/', { slugSection: slug }, true)
                .then(function (result) {
                resolve(result);
            }, function (error) {
                console.log('Ошибка при получении списка разделов предмета', error);
...
/* harmony import */ var _subsection_subsection_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../subsection/subsection.service */ "./src/app/components/subsection/subsection.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WorkComponent = /** @class */ (function () {
    function WorkComponent(workService, router, globalParamsMessage, activatedRoute, globalParamsUser, subsectionService, sanitizer) {
        var _this = this;
        this.workService = workService;
        this.router = router;
        this.globalParamsMessage = globalParamsMessage;
        ...
        this.lesson = { id: '', name: '', section_id: '', slug: '', is_status: '', is_bought: false };
        ...
        this.activatedRoute.params.subscribe(function (params) {
            _this.params = params;
            _this.getWorkCurrent(params.id, params.ss);
        });
    }
    WorkComponent.prototype.getWorkCurrent = function (slugSection, slugLesson) {
        var _this = this;
        this.workService.getWork(slugSection, slugLesson).then(function (data) {
            _this.section = data;
            ...
            for (var i = 0; i < _this.storage.length; i++) {
                if (_this.storage[i].type === 'pdf') {
                    _this.storage[i].url =
                        _this.sanitizer.bypassSecurityTrustResourceUrl('https://api.examator.ru/images/lessons/' + _this.storage[i].name);
                }
            }
    ...
    WorkComponent.prototype.changeShowBuy = function (price, slug) {
        this.buyModal = {
            show: true,
            price: price,
            slug: slug,
    ...
    WorkComponent.prototype.usePromotionalCode = function () {
        var _this = this;
        if (this.promo !== '') {
            this.subsectionService.usePromotionalCode({
                price: this.buyModal.price,
    ...
    WorkComponent.prototype.changeLessons = function (section_slug, currentWork_slug) {
        this.answerTest = [];
        this.testIndex = 0;
        this.showBtnSend = false;
        this.answer = '';
    ...
    WorkComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_work_service__WEBPACK_IMPORTED_MODULE_1__["WorkService"],
            ...
            _subsection_subsection_service__WEBPACK_IMPORTED_MODULE_6__["SubsectionService"],
...
var SessionStorageService = /** @class */ (function () {
    function SessionStorageService(router, globalParamsUser, cookieService) {
        this.router = router;
        this.globalParamsUser = globalParamsUser;
        this.cookieService = cookieService;
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.sendPostQuery = function (api, data, post) {
        ...
        if (post) {
            ...
            var url = 'https://api.examator.ru/' + api;
        ...
        return this.http.get('https://api.examator.ru/' + api, { headers: headers }).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(HttpService_1.handlerError));
    };
    var HttpService_1;
...
module.exports = __webpack_require__(/*! /home/almaz/client_online_school/src/main.ts */"./src/main.ts");
